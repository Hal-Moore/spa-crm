...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@/utils/messages'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    if (!(function webpackMissingModule() { var e = new Error("Cannot find module '@/utils/messages'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())[this.$route.query.message]) {
      this.$message(!(function webpackMissingModule() { var e = new Error("Cannot find module '@/utils/messages'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())[this.$route.query.message]);
    }
  },
  methods: {
